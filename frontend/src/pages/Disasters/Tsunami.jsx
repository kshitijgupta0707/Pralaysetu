    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-500 to-blue-700 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-white mb-2">Tsunami Risk Predictor</h1>
          <p className="text-xl text-blue-100">
            Assess the tsunami risk based on earthquake data and geographical coordinates
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="md:flex">
            ...
            <div className="bg-blue-50 md:w-1/3 p-6 md:p-8 border-l border-blue-100">
              <div className="mb-8">
                <h3 className="text-lg font-medium text-gray-800 mb-2">Tsunami Prediction</h3>
                <p className="text-gray-600 text-sm">
                  Our model analyzes earthquake parameters to assess the likelihood of tsunami formation based on historical data and geographical factors.
                </p>
              </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="bg-white rounded-lg shadow p-4 text-center">
                    ...
                    <div className="text-3xl font-bold text-gray-800">
                      {result === "Yes" ? "Tsunami Likely" : "No Tsunami Expected"}
                    </div>
                    
                    <p className="text-gray-600 mt-1">Prediction Result</p>
                    
                    <div className="mt-4">
                      <span className={`inline-block px-3 py-1 rounded-full text-white text-sm ${
                        result === "Yes" ? "bg-red-500" : "bg-green-500"
                      }`}>
              ...
              <div className="bg-blue-100 rounded-lg p-4">
                <h4 className="font-medium text-blue-800 mb-2">PralaySetu Tsunami Safety Tips</h4>
                <ul className="text-sm text-blue-700 space-y-2">
                  ...
                  <li className="flex items-start">
                    ...
                    Stay away from the beach and shoreline
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-blue-600 mr-1.5 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          ...
          <div className="bg-gray-50 px-6 py-4 md:px-8">
            <p className="text-sm text-gray-500 text-center">
              This tool provides an estimation based on provided inputs. For critical decisions, always follow official warnings and guidance from local authorities.
            </p>
          </div>
        </div>
      </div>
